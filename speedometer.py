...
class Speedometer(QObject):
    def __init__(self, parent=None):
        ...
        self.timer_speed.start(1000)  # Her 1000 milisaniyede bir (1 saniye) güncelleme yapacak
        self.timer_battery.start(1000)  # Her 1000 milisaniyede bir (1 saniye) güncelleme yapacak
        self.timer_temp.start(1000)  # Her 1000 milisaniyede bir (1 saniye) güncelleme yapacak
        self.timer_watt.start(1000)  # Her 1000 milisaniyede bir (1 saniye) güncelleme yapacak
        self.timer_volt.start(1000)  # Her 1000 milisaniyede bir (1 saniye) güncelleme yapacak
    ...
    def updateValueSpeed(self):
        ...
        self.anim_speed.setDuration(1000)  # Geçiş süresi: 1 saniye
    ...
    def updateValueBattery(self):
        ...
        self.anim_battery.setDuration(1000)  # Geçiş süresi: 1 saniye
    ...
    def updateValueTemp(self):
        ...
        self.anim_temp.setDuration(1000)  # Geçiş süresi: 1 saniye
    ...
    def updateValueWatt(self):
        ...
        self.anim_watt.setDuration(1000)  # Geçiş süresi: 1 saniye
    ...
    def updateValueVolt(self):
        ...
        self.anim_volt.setDuration(1000)  # Geçiş süresi: 1 saniye
...
class SpeedometerApp(QApplication):
    def __init__(self, argv):
        ...
        self.speedometer = Speedometer()  # Speedometer sınıfını başlat
